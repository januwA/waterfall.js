...
})(WaterfallAlignment || (WaterfallAlignment = {}));
exports.WaterfallAlignment = WaterfallAlignment;
class Waterfall {
    constructor({ root, item, alignment = WaterfallAlignment.start /*start|center|end|between*/, reverse = false /*true|false*/, resizeDebounce = 300 /*resize事件的防抖时间*/, resize = true }) {
        /**
         * * version [0.1.1]
         ...
         */
        this.alignment = WaterfallAlignment.start;
        /**
         * * 每行是否颠倒
         * * default is [false]
         */
